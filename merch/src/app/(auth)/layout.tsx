...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
      ...
      <section className="hidden lg:flex flex-col justify-between bg-dark-900 text-light-100 p-10">
        <div className="flex items-center">
          <div className="h-8 w-8 rounded-md bg-orange inline-flex items-center justify-center">
            <Image src="/logo.svg" alt="Better Auth Merch Website" width={20} height={20} />
          </div>
        </div>
  ...
  <p className="text-footnote text-light-400">© 2025 Better Auth Merch Website. All rights reserved.</p>
      </section>
